...
const Tuition = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      console.log('Fetched tuitions:', tuitionsRes.data);
      ...
      {selectedTuition ? (
        ...
        <div className="bg-white rounded-lg shadow p-12 text-center">
          <div className="max-w-md mx-auto">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">No Tuition Records Yet</h3>
            <p className="text-gray-600 mb-4">
              Your tuition records will appear here once your enrollment is approved by the registrar.
            </p>
            <p className="text-sm text-gray-500">
              If you have already enrolled and your enrollment was approved, please refresh the page or contact the registrar's office.
            </p>
          </div>
        </div>
      )}
